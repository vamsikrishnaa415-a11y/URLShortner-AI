...
@ControllerAdvice
/**
 * Maps URL service validation and domain failures to consistent HTTP error responses.
 */
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleDuplicateUrl(
        ...
        public ResponseEntity<ErrorResponse> handleDataIntegrityViolation(
                ...
                LOGGER.warn("Data integrity violation for {}", request.getRequestURI());
                return buildResponse(HttpStatus.CONFLICT, "The URL mapping conflicts with an existing record", request, Map.of());
        }
